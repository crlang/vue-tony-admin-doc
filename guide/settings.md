...
VITE_PORT=12321
# 网站标题，空格用 {space} 来间隔
VITE_GLOB_APP_TITLE=Tony{space}Admin
...
想要获取 `_app.config.js` 内的变量，可以使用 [src/hooks/setting/index.ts](https://github.com/crlang/vue-tony-admin/tree/main/src/hooks/setting/index.ts) 提供的函数来进行获取
...
3. [useGlobSetting](https://github.com/crlang/vue-tony-admin/tree/main/src/hooks/setting/index.ts) 函数中添加刚新增的返回值即可
...
[src/settings/projectSetting.ts](https://github.com/crlang/vue-tony-admin/tree/main/src/settings/projectSetting.ts)
...
在 [@/settings/encryptionSetting.ts](https://github.com/crlang/vue-tony-admin/blob/main/src/settings/encryptionSetting.ts) 内可以配置 `localStorage` 及 `sessionStorage` 缓存信息

**前提:** 使用项目自带的缓存工具类 [@/utils/cache](https://github.com/crlang/vue-tony-admin/blob/main/src/utils/cache/index.ts) 来进行缓存操作
...
在 [src/settings/localeSetting.ts](https://github.com/crlang/vue-tony-admin/tree/main/src/settings/localeSetting.ts) 内配置
...
默认全局主题色配置位于 [build/config/glob/themeConfig.ts](https://github.com/crlang/vue-tony-admin/tree/main/build/config/themeConfig.ts) 内
...
- 在 [src/design/var/index.scss](https://github.com/crlang/vue-tony-admin/blob/main/src/design/var/index.scss) 配置 css 前缀
...
在 [src/settings/designSetting.ts](https://github.com/crlang/vue-tony-admin/tree/main/src/settings/designSetting.ts) 内配置
...
在 [src/settings/componentSetting.ts](https://github.com/crlang/vue-tony-admin/tree/main/src/settings/componentSetting.ts) 内配置
